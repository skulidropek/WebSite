...
{
    internal class AnalyzeConfigurationServiceLastDevBlog : IAnalyzeConfigurationService
    {
        ...
        public string ConfigurationName => nameof(AnalyzeConfigurationServiceLastDevBlog);
